                ...
                <table class="nav-justified">
                    ...
                    <tr>
                        ...
                        <td class="auto-style5">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Repuestos2ConnectionString13 %>" SelectCommand="select distinct(t1.id), t1.patente, t1.km, t1.nro_motor, t1.id_modelo, t1.nro_chasis from Auto as t1 
"></asp:SqlDataSource>
                        </td>
                        <td>&nbsp;</td>
                    </tr>
