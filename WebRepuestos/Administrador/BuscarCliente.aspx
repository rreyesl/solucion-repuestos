        ...
        <div class="row">
            ...
            <div class="col-sm-6 panel-g">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <asp:TextBox ID="txtDv" CssClass="form-control" runat="server" ReadOnly="True" Width="46px"></asp:TextBox>
                    </div>
                    <div class="col-sm-3">
                        <asp:Button ID="btnBuscar" CssClass="btn btn-purple" runat="server" OnClick="btnBuscar_Click" style="height: 26px" Text="Buscar" />
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                         <asp:Button ID="txtEliminar" CssClass="btn btn-purple" runat="server" OnClick="txtEliminar_Click" Text="Eliminar" />
