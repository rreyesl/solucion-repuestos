<%@ Page Title="" Language="C#" MasterPageFile="~/Administrador/Administrador1.Master" AutoEventWireup="true" CodeBehind="EditarServicio.aspx.cs" Inherits="WebRepuestos.Administrador.EditarServicio" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Repuestos2ConnectionString3 %>" SelectCommand="SELECT s.[id], s.[descripcion], s.[fecha_ingreso], s.[fecha_entrega], s.[valor_iva], 
